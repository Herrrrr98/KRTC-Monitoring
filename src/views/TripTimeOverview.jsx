...
export default function PageView() {
  ...
  return (
    <div style={{ padding: '30px', color: 'var(--text-main)', backgroundColor: 'var(--bg-trainLiveBox)'}}>
      <button 
        ...
        { isLoading ? (
          ...
          Array.isArray(analyzedData) && analyzedData.length > 0 ? (
            analyzedData.map((d, index) => (
              <AnalyzedTripTimeCard key={index} AnalyzedData={d} index={index}></AnalyzedTripTimeCard>
            ))
          ) : (
